package com.github.seecret.jwtexample.repository.impl;

import com.github.seecret.jwtexample.entity.RefreshToken;
import com.github.seecret.jwtexample.exception.RefreshTokenException;
import com.github.seecret.jwtexample.repository.RefreshTokenRepository;
...
public class RefreshTokenRepositoryImpl implements RefreshTokenRepository {
    ...
    public RefreshTokenRepositoryImpl(
            ReactiveRedisTemplate<String, RefreshToken> refreshTokenRedisTemplate
    ) {
    ...
    public Mono<RefreshToken> getByValue(String refreshToken) {
        if (refreshToken == null || refreshToken.isBlank()) {
            return Mono.error(new RefreshTokenException("Refresh token value must not be null or empty"));
        }
